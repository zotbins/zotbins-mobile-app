  ...
  <Text className="text-sm font-medium text-green-800 mb-2">New Email</Text>
      ...
      {showVerificationPopup && (
        ...
        >
          ...
          >
            <Text style={{ fontSize: 20, fontWeight: "bold", color: "#14532d", paddingVertical:16, textAlign: "center" }}>
              Verify Your New Email
            </Text>
            <Text style={{ textAlign: "center", color: "#374151", fontSize: 14, marginBottom: 24 }}>
            ...
            >
              <Text style={{ color: "white", fontWeight: "bold", fontSize: 16 }}>Resend</Text>
            </Pressable>
